...
export function generateSeedDb(
  ...
  const trafficRng = rootRng.fork("wholesale-traffic");
  ...
  const db: DbState = {
    ...
    amEntries: (() => {
      ...
      const r = (obj: Record<string, string>): Record<string, string> => obj;
      ...
      return [
        { id: "am-01", tab: "Route Request" as const, fields: r({ Destination: "Nigeria MTN", "Target Rate": "7.5", Volume: "10K/day" }), submittedBy: "Sarah Mitchell", submittedAt: past(6), expiresAt: future(42), isArchived: false, comments: [c("amc-01", "BT Wholesale has good rates for MTN, I can connect you", "James Carter", 4), c("amc-02", "Syniverse also competitive here, check their portal", "Timur Aslan", 2)] },
        { id: "am-02", tab: "Route Request" as const, fields: r({ Destination: "Germany Telekom", "Target Rate": "12.0", Volume: "50K/day" }), submittedBy: "Ceren Yıldız", submittedAt: past(3), expiresAt: future(45), isArchived: false, comments: [] },
        { id: "am-03", tab: "Traffic Request" as const, fields: r({ Destination: "Turkey Turkcell", Rate: "9.0", Volume: "25K/day" }), submittedBy: "Elif Demir", submittedAt: past(10), expiresAt: future(38), isArchived: false, comments: [c("amc-03", "We have capacity on Turkcell, let's discuss", "Rania Al-Hassan", 8)] },
        { id: "am-04", tab: "Traffic Request" as const, fields: r({ Destination: "India Airtel", Rate: "5.5", Volume: "100K/day" }), submittedBy: "Timur Aslan", submittedAt: past(1), expiresAt: future(47), isArchived: false, comments: [] },
        { id: "am-05", tab: "Targets" as const, fields: r({ Destination: "France Orange", "Target Rate": "11.0", Volume: "30K/day" }), submittedBy: "James Carter", submittedAt: past(12), expiresAt: future(36), isArchived: false, comments: [] },
